...
class HouseRobberII:
    ...
    def HouseRobberSolution(self, num):
...
if __name__ == "__main__":
    ...
    nums3 = [0]
    s = HouseRobberII()
    print("Solution 1 with example 1: ", s.Solution1(nums1))
    print("Solution 1 with example 2: ", s.Solution1(nums2))
    print("Solution 1 with example 3: ", s.Solution1(nums3))
